...
# ==========================================
# PANEL WINGS INSTALLER - MR VEXY EDITION
# ==========================================
...
loading_bar() {
    clear
    echo -e "${B_RED}Initializing Mr Vexy Installer...${NC}"
    echo -ne "${B_RED}[${NC}"
    for i in {1..40}; do
        echo -ne "${B_WHITE}█${NC}"
        sleep 0.03
...
EOF
    echo -e "${NC}"
    echo -e "${B_RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${B_WHITE}                  Made By - Mr Vexy${NC}"
    echo -e "${B_RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
    ...
    while true; do
        ...
        case $p in
            1) 
                ...
                bash <(curl -s https://ptero.mrvexy.site)
                ;;
            2) 
                echo -e "${B_GREEN}Starting Air-Link Installer...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/mrvexy-limited/app-build-journey/refs/heads/main/air-link)
                ;;
            3) return ;;
            *) echo -e "${B_RED}Invalid Option${NC}"; sleep 1 ;;
        esac
...
while true; do
    ...
    case ${choice,,} in
        ...
        b)
            ...
            bash <(curl -s https://raw.githubusercontent.com/mrvexy-limited/app-build-journey/refs/heads/main/vpmaker)
            pause
            ;;
        c)
            tools_menu
        ...
        d)
            ...
            ;;
        e)
            echo -e "${B_GREEN}Thank you for using Mr Vexy Installer!${NC}"
